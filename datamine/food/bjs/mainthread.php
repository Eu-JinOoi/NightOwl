...
function convertTimes($time)
{
	...
	$url1="http://hosted.where2getit.com/bjsrestaurant/ajax?&xml_request=%3Crequest%3E%3Cappkey%3EE44D00DE-57DE-11DF-9086-D8145B67B72A%3C%2Fappkey%3E%3Cformdata+id%3D%22locatorsearch%22%3E%3Cdataview%3Estore_default%3C%2Fdataview%3E%3Cgeolocs%3E%3Cgeoloc%3E%3Caddressline%3E";
	$url2="%3C%2Faddressline%3E%3Clongitude%3E%3C%2Flongitude%3E%3Clatitude%3E%3C%2Flatitude%3E%3C%2Fgeoloc%3E%3C%2Fgeolocs%3E%3Csearchradius%3E15%7C25%7C50%7C100%7C250%3C%2Fsearchradius%3E%3Cwhere%3E%3Cclientkey%3E%3Cnotin%3E9999%3C%2Fnotin%3E%3C%2Fclientkey%3E%3C%2Fwhere%3E%3C%2Fformdata%3E%3C%2Frequest%3E";
	...
	foreach($zips as $zipx)
	{
		...
		foreach ($elem as $poi) 
		{
			...
			foreach($poi as $epoi)
			{
				...
				else if($epoi->getName()=="full_bar")
				{
					if(strtolower($epoi)=="y")
					{
						$alcohol=1;	
					}
				}
